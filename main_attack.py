...
def run_diffusion_attack(image, label, diffusion_model,custom_loss,
    ...
    adv_image, clean_acc, adv_acc , target_acc, = diff_latent_attack.latent_attack(diffusion_model, label, custom_loss,target_label,
...
if __name__ == "__main__":
    ...
    all_images = np.array(filterDatapath)[:5]
    label = np.array(filterLabels)[:5]
