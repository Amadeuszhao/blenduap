...
class LocalBlend:
    ...
    def __call__(self, x_t, attention_store):
        ...
        if self.counter > self.start_blend:
            ...
            # print('this is perturb grad 3',pert.requires_grad)
...
def run_and_display(prompts, controller, num_diffusion_steps = 50,guidance_scale=7.5, ldm_stable=None,latent=None, run_baseline=False, generator=None,uncond_embeddings=None ):
    ...
    images, x_t = ptp_utils_test.text2image_ldm_stable(ldm_stable, prompts, controller, latent=latent, num_inference_steps=num_diffusion_steps, guidance_scale=guidance_scale, generator=generator, uncond_embeddings=uncond_embeddings)
